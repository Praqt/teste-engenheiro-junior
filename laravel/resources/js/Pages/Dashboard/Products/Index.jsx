        ...
        <AuthenticatedLayout user={auth.user}
            header={
                <div className="flex justify-between">
                    <h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Listagem de Produtos</h2>
                        ...
                        <table className="w-full table-auto text-gray-900 dark:text-gray-200">
                            <thead>
                                <tr>
                                    ...
                                    <th className="text-start border-b border-slate-600 bg-red-900">Preço</th>
                                    <th className="text-start border-b border-slate-600 bg-red-900">Estoque</th>
