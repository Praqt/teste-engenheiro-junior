...
export default function Form({ auth, order }) {
    ...
    useEffect(() => {
        ...
        if (selectedClient === null && order) {
            axios
                ...
                .then((res) => {
                    if (res.status !== 404) setSelectedClient(res.data.data);
                })
                .catch((e) => console.log(e));
        }
    }, []);
    ...
    function handleSubmit(e) {
        ...
        else put(route("dashboard.orders.update", order.id));
    }
            ...
            header={
                <div className="flex justify-between">
                    <h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                        {order ? "Alterar Pedido" : "Novo Pedido"}
                    </h2>
                </div>
            }
        >
                    ...
                    <div className="bg-white dark:bg-gray-800 w-1/2 mx-auto overflow-hidden shadow-sm sm:rounded-lg">
                        {clients && products ? (
                            ...
                            <div className="p-5 text-white">
                                Não há clientes e/ou produtos para realizar um
                                pedido!
                            </div>
                        )}
                    </div>
