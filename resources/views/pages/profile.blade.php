          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">Sobral CE</p>
                ...
                <p class="text-muted">
                  <span class="tag tag-danger">Desenvolvedor Fullstack</span>
                  <span class="tag tag-success">PHP, Laravel</span>
                  <span class="tag tag-info">Javascript</span>
                  <span class="tag tag-warning">Vuejs, Nuxtjs</span>
                  <span class="tag tag-primary">Node.js Nestjs</span>
                </p>
